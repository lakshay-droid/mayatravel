...
export const Navbar: React.FC = () => {
  ...
  const navItems = [
    { path: '/', label: 'Explore', icon: <Compass size={18} /> },
    { path: '/planner', label: 'Trip Planner', icon: <CalendarRange size={18} /> },
    { path: '/profile', label: 'My Lens', icon: <User size={18} /> },
  ];
      ...
      <Link to="/" className="flex items-center gap-2 group">
        ...
        <div className="flex flex-col">
          <span className="font-bold text-slate-800 text-base leading-none tracking-tight flex items-center gap-1">
            LocalLens <Sparkles size={12} className="text-primary fill-primary" />
          </span>
