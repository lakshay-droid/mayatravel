          ...
          <div className="glass-card p-6 flex flex-col items-center text-center gap-5 relative overflow-hidden">
            ...
            <div className="flex flex-col gap-2 bg-background border border-border p-4 rounded-2xl w-full text-left select-none">
              <span className="text-[9px] font-bold text-text-secondary uppercase tracking-wider flex items-center gap-1">
                <Shield size={10} className="text-primary" /> RLS Protection Active
              </span>
            ...
            <form onSubmit={handleUpdate} className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 select-none">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-semibold tracking-wider text-text-secondary uppercase">Travel Personality</label>
                  <select
                    value={personality}
                ...
                {/* 2. Scenery */}
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-semibold tracking-wider text-text-secondary uppercase">Soul Destination</label>
                  <select
                    value={destination}
                ...
                {/* 3. Transport */}
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-semibold tracking-wider text-text-secondary uppercase">Preferred Transport</label>
                  <select
                    value={transport}
                ...
                {/* 4. Group */}
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-semibold tracking-wider text-text-secondary uppercase">Travel Dynamics</label>
                  <select
                    value={group}
                ...
                {/* 5. Food */}
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-semibold tracking-wider text-text-secondary uppercase">Dietary Focus</label>
                  <select
                    value={food}
                ...
                {/* 6. Budget */}
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-semibold tracking-wider text-text-secondary uppercase">Budget Plan</label>
                  <select
                    value={budget}
